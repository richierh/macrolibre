...
제품의 개발을 담당하고 있는 LibreOffice 커뮤니티는 여러분의 참여를 기다립니다. 새 사용자는 LibreOffice 사이트를 방문하여 LibreOffice 프로젝트와 커뮤니티에 대한 다양한 정보를 얻을 수 있습니다. http://ko.libreoffice.org/를 방문해 보십시오.
...
RPMS(또는 DEBS) 디렉터리에도 libreoffice6.0-freedesktop-menus-6.0.0.1-1.noarch.rpm (또는 libreoffice6.0-debian-menus_6.0.0.1-1_all.deb) 이라는 패키지가 있습니다. 이 패키지는 Freedesktop.org 기술 사양/추천 (https://en.wikipedia.org/wiki/Freedesktop.org) 내용을 지원하는 모든 리눅스 배포판을 위한 패키지입니다. 그리고 앞서 기술한 설치 방법을 지원하지 않는 다른 리눅스 배포판을 위한 설치 방법도 제공합니다.
...
현재 버그를 보고, 추적, 해결하기 위해 버그질라(http://bugs.documentfoundation.org/)를 사용하고 있습니다. 모든 사용자는 각자의 플랫폼에서 발생하는 버그를 보고할 권리가 있고, 이는 환영할 만한 일입니다. 활발한 버그 보고는 LibreOffice의 지속적인 개발과 향상을 위한 사용자 커뮤니티가 할 수 있는 가장 중요한 기여입니다.
...
https://ko.libreoffice.org/get-help/mailing-lists/에 여러분이 구독할 수 있는 메일링 리스트가 나와 있습니다.
...
우리는 여러분이 LibreOffice 6.0을 위해 일하는 것을 즐기기 바라며 온라인으로 함께 참여하기를 희망합니다.
